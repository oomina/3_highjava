...
//			br = new BufferedReader(new FileReader("D:/A_TeachingMaterial/3_highjava/workspace/javaIOTest/src/kr/or/ddit/basic/FileTest01.java"));  // 절대경로
			br = new BufferedReader(new FileReader("./src/kr/or/ddit/basic/FileTest01.java"));  // 상대경로
			
			String temp = "";  // 읽어온 문자열이 저장될 변수
			
			// 문자기반의 입력용 퍼버스트림은 데이터를  한 줄 단위로 읽어오는 메서드를 지원한다.
