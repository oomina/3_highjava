...
public class VectorTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("v1 => " + v1.toString()); //.toString() 생략 가능
		...
		*/
		...
		String sTemp2 = v3.get(0); // 형변환 없이 사용할 수 있다. => 타입이 일치할 때는 형변환을 안해줘도 된다
